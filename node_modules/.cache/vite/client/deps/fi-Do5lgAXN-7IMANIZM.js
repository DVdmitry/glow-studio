// node_modules/typelessform-widget/dist/fi-Do5lgAXN.js
var t = {
  "modal.title": "Kerro meille näistä aiheista",
  "modal.subtitle": "Ymmärrämme mitä tahansa kieltä, täytämme kaiken ja käännämme tarvittaessa",
  ...
  "error.lowConfidence": "Ääntä ei voitu ymmärtää selkeästi. Puhu selkeämmin.",
  "error.general": "Jotain meni pieleen. Yritä uudelleen.",
  "error.domainNotAllowed": "Tämä verkkotunnus ei ole valtuutettu käyttämään palvelua. Ota yhteyttä verkkosivuston ylläpitäjään.",
  ...
  "error.no_fields_detected": "Lomakkeen täyttämiseen tarvittavia tietoja ei tunnistettu. Yritä määrittää selkeämmin, mitä tietoja kenttiin tulee syöttää.",
  ...
  "consent.warning": "Älä mainitse salasanoja, maksudetaileja, viranomaistunnuksia tai lääketieteellisiä tietoja. Näitä tietoja ei ole tarkoitettu äänitoiminnon käsiteltäväksi.",
  "consent.summary_card1_title": "Mitä Keräämme",
  "consent.summary_data1": "Äänitallennus → muunnettu tekstiksi",
  "consent.summary_data2": "Kenttien nimet/tyypit/paikkamerkit (ilman arvoja; arkaluonteiset kentät poistettu)",
  "consent.summary_data3": "Tekniset lokit (IP, selaintiedot)",
  "consent.summary_card2_title": "Minne Se Menee",
  "consent.summary_transfer": "OpenAI (USA) AI-käsittelyyn • Google Cloud/Firebase (EU, Puola) hostingiin ja turvallisuuteen",
  "consent.summary_card3_title": "Oikeutesi",
  "consent.summary_rights": "Peruuta suostumus milloin tahansa • Pyydä pääsyä tai tietojesi poistoa • Täydelliset tiedot <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Tietosuojakäytännössä</a>",
  "consent.full_details_title": "Lue Täydelliset Tiedot",
  "consent.section1_title": "Mitä tietoja käsittelemme?",
  "consent.data1": "Äänitallennus. Äänitiedosto lähetetään OpenAI Whisperille palvelimemme kautta transkriptiota varten. Tiedostoa ei tallenneta palvelimelle käsittelyn jälkeen.",
  "consent.data2": "Äänitranskriptio (teksti). Lähetetään OpenAI GPT:lle lomakkeen täyttöä varten. Oletuksena emme tallenna transkriptiota järjestelmiimme; teknisissä lokeissa tallennamme vain metatiedot (tekstin pituus, kieli, kesto). Tärkeää: OpenAI saattaa tallentaa pyyntötiedot 30 päivään asti väärinkäytön estämiseksi; varhainen poisto OpenAI:ssa ei ole saatavilla; tietoja ei käytetä mallien kouluttamiseen.",
  "consent.data3": "Lomakekentän metatiedot. Nimet/tyypit/paikkamerkit (arkaluonteiset kentät poistettu).",
  "consent.data4": "Sivun URL. Infrastruktuurimme käsittelee (yhteensopivuuteen/diagnostiikkaan), EI lähetetä OpenAI:lle. Vältä henkilötietoja URL-kyselyparametreissa.",
  "consent.data5": "Selaimen User-Agent. Käytetään paikallisesti ja infrastruktuurissamme (yhteensopivuus/turvallisuus), EI lähetetä OpenAI:lle.",
  "consent.data6": "IP-osoite. Google Cloud/Firebase-infrastruktuuri kirjaa turvallisuuden vuoksi (enintään 30 päivää), EI lähetetä OpenAI:lle.",
  "consent.section2_title": "Minne ja millä oikeusperusteella tiedot siirretään?",
  "consent.recipients": "Vastaanottajat. OpenAI (USA) — ääni-/tekstinkäsittely; Google Cloud/Firebase (EU/Puola) — hosting ja turvallisuuslokit. Tietoja ei käytetä mallien kouluttamiseen.",
  "consent.transfer1": "OpenAI (USA). OpenAI:lle tehdyt pyynnöt (mukaan lukien ääni/teksti) saattavat tallentua OpenAI:lle 30 päivään asti väärinkäytön estämiseksi; tietoja ei käytetä mallien kouluttamiseen. Siirto Yhdysvaltoihin — perustuu Euroopan komission hyväksymiin SCC:hin.",
  "consent.basis_title": "Oikeusperusteet:",
  "consent.basis1": "Äänitoiminto — suostumuksesi (Art. 6(1)(a) GDPR).",
  "consent.basis2": "Tekniset lokit (IP/UA/URL) — oikeutetut edut (Art. 6(1)(f)) — turvallisuus ja virheenkorjaus.",
  "consent.section3_title": "Oikeutesi",
  "consent.rights1": "Voit peruuttaa suostumuksen widget-asetuksissa milloin tahansa; tämä ei vaikuta käsittelyn laillisuuteen ennen peruutusta.",
  "consent.rights2": "Suostumuksen peruuttamisen lisäksi sinulla on oikeus pyytää pääsyä tai järjestelmiin tallennettujen tietojesi poistoa (tekniset lokit, kustannusmittarit) verkkosivuston omistajan kautta. Täydelliset tiedot <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Tietosuojakäytännössä</a>.",
  "consent.rights3": "Tämä toiminto on tarkoitettu 16+ -käyttäjille; nuoremmille käyttäjille vaaditaan vanhemman/huoltajan suostumus.",
  "consent.footer_legal_title": "Oikeudelliset Tiedot",
  "consent.footer_controller": "Rekisterinpitäjä: tämän verkkosivuston omistaja.",
  "consent.footer_processor": "TypelessForm: toimii käsittelijänä.",
  "consent.footer_contact": "Tietosuojayhteys: info@webappski.com.",
  "consent.footer_sccs": "Siirto Yhdysvaltoihin suoritetaan SCC:n mukaisesti. Yksityiskohdat ovat saatavilla <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Tietosuojakäytännössämme</a>.",
...
//# sourceMappingURL=fi-Do5lgAXN-7IMANIZM.js.map
