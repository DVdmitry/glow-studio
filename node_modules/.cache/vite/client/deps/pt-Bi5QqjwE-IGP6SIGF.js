// node_modules/typelessform-widget/dist/pt-Bi5QqjwE.js
var e = {
  "modal.title": "Conte-nos sobre esses tópicos",
  "modal.subtitle": "Entendemos qualquer idioma, preencha tudo e traduza se necessário",
  ...
  "success.subtitle": "Revise os campos preenchidos e envie quando estiver pronto",
  ...
  "error.noActiveForm": "Nenhum formulário ativo encontrado para preenchimento",
  "error.lowConfidence": "Não foi possível entender claramente o áudio. Por favor, fale mais claramente.",
  "error.general": "Algo deu errado. Por favor, tente novamente.",
  "error.domainNotAllowed": "Este domínio não está autorizado a usar o serviço. Entre em contato com o administrador do site.",
  "error.serviceUnavailable": "Serviço temporariamente indisponível. Por favor, tente novamente mais tarde ou entre em contato com o administrador do site.",
  ...
  "error.no_fields_detected": "Não foi possível reconhecer informações para preencher o formulário. Por favor, tente especificar mais claramente quais dados devem ser inseridos nos campos.",
  ...
  "consent.subtitle": "Por favor, leia atentamente as informações sobre a proteção de seus dados",
  "consent.warning_title": "Importante: Não Compartilhe Dados Sensíveis",
  "consent.warning": "Por favor, não mencione senhas, detalhes de pagamento, identificadores governamentais ou informações médicas. Estes dados não são destinados ao processamento pelo recurso de voz.",
  "consent.summary_card1_title": "O Que Coletamos",
  "consent.summary_data1": "Gravação de voz → convertida em texto",
  "consent.summary_data2": "Nomes/tipos/espaços reservados de campos (sem valores; campos sensíveis excluídos)",
  "consent.summary_data3": "Registros técnicos (IP, informações do navegador)",
  "consent.summary_card2_title": "Para Onde Vai",
  "consent.summary_transfer": "OpenAI (EUA) para processamento de IA • Google Cloud/Firebase (UE, Polônia) para hospedagem e segurança",
  "consent.summary_card3_title": "Seus Direitos",
  "consent.summary_rights": "Retirar consentimento a qualquer momento • Solicitar acesso ou exclusão de seus dados • Detalhes completos na <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Política de Privacidade</a>",
  "consent.full_details_title": "Ler Detalhes Completos",
  "consent.section1_title": "Quais dados processamos?",
  "consent.data1": "Gravação de voz. Arquivo de áudio enviado ao OpenAI Whisper através de nosso servidor para transcrição. O arquivo não é salvo no servidor após o processamento.",
  "consent.data2": "Transcrição de voz (texto). Enviada ao OpenAI GPT para preenchimento de formulários. Por padrão, não salvamos a transcrição em nossos sistemas; nos registros técnicos armazenamos apenas metadados (comprimento do texto, idioma, duração). Importante: a OpenAI pode armazenar dados de solicitação por até 30 dias para prevenir abusos; a exclusão antecipada na OpenAI não está disponível; os dados não são usados para treinamento de modelos.",
  "consent.data3": "Metadados de campos de formulário. Nomes/tipos/espaços reservados (campos sensíveis excluídos).",
  "consent.data4": "URL da página. Processado por nossa infraestrutura (para compatibilidade/diagnósticos), NÃO enviado à OpenAI. Evite dados pessoais em parâmetros de consulta de URL.",
  "consent.data5": "User-Agent do navegador. Usado localmente e por nossa infraestrutura (compatibilidade/segurança), NÃO enviado à OpenAI.",
  "consent.data6": "Endereço IP. Registrado pela infraestrutura Google Cloud/Firebase para segurança (até 30 dias), NÃO enviado à OpenAI.",
  "consent.section2_title": "Para onde e com base em qual fundamento legal os dados são transferidos?",
  "consent.recipients": "Destinatários. OpenAI (EUA) — processamento de áudio/texto; Google Cloud/Firebase (UE/Polônia) — hospedagem e registros de segurança. Os dados não são usados para treinamento de modelos.",
  "consent.transfer1": "OpenAI (EUA). Solicitações à OpenAI (incluindo áudio/texto) podem ser armazenadas pela OpenAI por até 30 dias para prevenir abusos; os dados não são usados para treinamento de modelos. Transferência para os EUA — com base em CCPs aprovadas pela Comissão Europeia.",
  "consent.basis_title": "Bases legais:",
  "consent.basis1": "Recurso de voz — seu consentimento (Art. 6(1)(a) GDPR).",
  "consent.basis2": "Registros técnicos (IP/UA/URL) — interesses legítimos (Art. 6(1)(f)) — segurança e depuração.",
  "consent.section3_title": "Seus direitos",
  "consent.rights1": "Você pode retirar o consentimento nas configurações do widget a qualquer momento; isso não afeta a legalidade do processamento antes da retirada.",
  "consent.rights2": "Além de retirar o consentimento, você tem o direito de solicitar acesso ou exclusão de seus dados armazenados em nossos sistemas (registros técnicos, métricas de custo) através do proprietário do site. Detalhes completos na <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Política de Privacidade</a>.",
  "consent.rights3": "Este recurso é destinado a usuários com 16 anos ou mais; para usuários mais jovens, é necessário o consentimento dos pais/responsável.",
  "consent.footer_legal_title": "Informações Legais",
  "consent.footer_controller": "Controlador de Dados: o proprietário deste site.",
  ...
  "consent.footer_sccs": "A transferência para os EUA é realizada sob CCPs. Detalhes estão disponíveis em nossa <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Política de Privacidade</a>.",
...
//# sourceMappingURL=pt-Bi5QqjwE-IGP6SIGF.js.map
