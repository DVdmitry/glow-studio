// node_modules/typelessform-widget/dist/sr-asktmtN2.js
var e = {
  "modal.title": "Reci nam o ovim temama",
  "modal.subtitle": "Razumemo sve jezike, popunimo sve i prevedemo po potrebi",
  ...
  "error.domainNotAllowed": "Ovaj domen nije ovlašćen da koristi uslugu. Molimo kontaktiraj administratora web sajta.",
  ...
  "error.no_fields_detected": "Nije moguće prepoznati informacije za popunjavanje obrasca. Molimo pokušajte jasnije navesti koje podatke treba uneti u polja.",
  ...
  "error.lowConfidence": "Nisam mogao jasno da razumem zvuk. Molimo govorite jasnije.",
  "button.close": "Zatvori",
  // Consent modal
  "consent.title": "Ваша Приватност Података",
  "consent.subtitle": "Молимо пажљиво прочитајте информације о заштити ваших података",
  "consent.warning_title": "Важно: Не Делите Осетљиве Податке",
  "consent.warning": "Молимо не помињите лозинке, детаље плаћања, државне идентификаторе или медицинске информације. Ти подаци нису намењени обради гласовном функцијом.",
  "consent.summary_card1_title": "Шта Прикупљамо",
  "consent.summary_data1": "Гласовни снимак → претворено у текст",
  "consent.summary_data2": "Називи/типови/заменски знакови поља (без вредности; осетљива поља искључена)",
  "consent.summary_data3": "Технички записи (IP, информације прегледача)",
  "consent.summary_card2_title": "Где Иде",
  "consent.summary_transfer": "OpenAI (САД) за AI обраду • Google Cloud/Firebase (ЕУ, Пољска) за хостинг и безбедност",
  "consent.summary_card3_title": "Ваша Права",
  "consent.summary_rights": "Повуците пристанак било када • Затражите приступ или брисање ваших података • Потпуни детаљи у <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Политици приватности</a>",
  "consent.full_details_title": "Прочитајте Потпуне Детаље",
  "consent.section1_title": "Које податке обрађујемо?",
  "consent.data1": "Гласовни снимак. Аудио датотека послата OpenAI Whisper-у преко нашег сервера за транскрипцију. Датотека се не чува на серверу након обраде.",
  "consent.data2": "Гласовна транскрипција (текст). Послато OpenAI GPT-у за попуњавање образаца. Према подразумеваним подешавањима не чувамо транскрипцију у нашим системима; у техничким записима чувамо само метаподатке (дужина текста, језик, трајање). Важно: OpenAI може похранити податке захтева до 30 дана како би спречио злоупотребу; рано брисање у OpenAI-у није доступно; подаци се не користе за обуку модела.",
  "consent.data3": "Метаподаци поља обрасца. Називи/типови/заменски знакови (осетљива поља искључена).",
  "consent.data4": "URL странице. Обрађен нашом инфраструктуром (за компатибилност/дијагностику), НИЈЕ послат OpenAI-у. Молимо избегавајте личне податке у параметрима упита URL-а.",
  "consent.data5": "User-Agent прегледача. Користи се локално и нашом инфраструктуром (компатибилност/безбедност), НИЈЕ послат OpenAI-у.",
  "consent.data6": "IP адреса. Забележена инфраструктуром Google Cloud/Firebase ради безбедности (до 30 дана), НИЈЕ послата OpenAI-у.",
  "consent.section2_title": "Где и на којој правној основи се преносе подаци?",
  "consent.recipients": "Примаоци. OpenAI (САД) — обрада звука/текста; Google Cloud/Firebase (ЕУ/Пољска) — хостинг и записи безбедности. Подаци се не користе за обуку модела.",
  "consent.transfer1": "OpenAI (САД). Захтеви OpenAI-у (укључујући звук/текст) могу бити похрањени од стране OpenAI-а до 30 дана како би се спречила злоупотреба; подаци се не користе за обуку модела. Пренос у САД — на основу SCC-а одобрених од стране Европске комисије.",
  "consent.basis_title": "Правне основе:",
  "consent.basis1": "Гласовна функција — ваш пристанак (чл. 6 ст. 1 тач. а) GDPR-а).",
  "consent.basis2": "Технички записи (IP/UA/URL) — легитимни интереси (чл. 6 ст. 1 тач. ф)) — безбедност и отклањање грешака.",
  "consent.section3_title": "Ваша права",
  "consent.rights1": "Пристанак можете повући у подешавањима виџета било када; то не утиче на законитост обраде пре повлачења.",
  "consent.rights2": "Осим повлачења пристанка, имате право затражити приступ или брисање ваших података похрањених у нашим системима (технички записи, метрику трошкова) преко власника веб странице. Потпуни детаљи у <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Политици приватности</a>.",
  "consent.rights3": "Ова функција је намењена корисницима од 16+; за млађе кориснике потребан је пристанак родитеља/старатеља.",
  ...
  "consent.footer_sccs": "Пренос у САД спроводи се према SCC-у. Детаљи су доступни у нашој <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Политици приватности</a>.",
...
//# sourceMappingURL=sr-asktmtN2-DZQ5UCWQ.js.map
