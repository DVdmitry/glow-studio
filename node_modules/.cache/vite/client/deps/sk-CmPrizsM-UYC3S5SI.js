// node_modules/typelessform-widget/dist/sk-CmPrizsM.js
var e = {
  "modal.title": "Povedzte nám o týchto témach",
  "modal.subtitle": "Rozumieme akémukoľvek jazyku, vyplníme všetko a preložíme, ak je to potrebné",
  ...
  "success.subtitle": "Skontrolujte vyplnené polia a odošlite, keď ste pripravení",
  ...
  "error.domainNotAllowed": "Táto doména nie je oprávnená používať službu. Kontaktujte prosím správcu webovej stránky.",
  ...
  "error.no_fields_detected": "Nepodarilo sa rozpoznať informácie na vyplnenie formulára. Skúste prosím jasnejšie určiť, aké údaje majú byť zadané do polí.",
  ...
  "error.lowConfidence": "Nepodarilo sa jasne rozpoznať zvuk. Prosím, hovorte zreteľnejšie.",
  "button.close": "Zatvoriť",
  // Consent modal
  "consent.title": "Vaše Súkromie Údajov",
  "consent.subtitle": "Prosím, pozorne si prečítajte informácie o ochrane vašich údajov",
  "consent.warning_title": "Dôležité: Nezdieľajte Citlivé Údaje",
  "consent.warning": "Prosím neuvádzajte heslá, platobné údaje, vládne identifikátory alebo zdravotné informácie. Tieto údaje nie sú určené na spracovanie hlasovou funkciou.",
  "consent.summary_card1_title": "Čo Zbierame",
  "consent.summary_data1": "Hlasový záznam → prevedený na text",
  "consent.summary_data2": "Názvy/typy/zástupné znaky polí (bez hodnôt; citlivé polia vylúčené)",
  "consent.summary_data3": "Technické protokoly (IP, informácie o prehliadači)",
  "consent.summary_card2_title": "Kam To Smeruje",
  "consent.summary_transfer": "OpenAI (USA) na spracovanie AI • Google Cloud/Firebase (EÚ, Poľsko) na hosting a zabezpečenie",
  "consent.summary_card3_title": "Vaše Práva",
  "consent.summary_rights": "Kedykoľvek odvolať súhlas • Požiadať o prístup alebo vymazanie vašich údajov • Úplné podrobnosti v <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Zásadách ochrany osobných údajov</a>",
  "consent.full_details_title": "Prečítať Úplné Podrobnosti",
  "consent.section1_title": "Aké údaje spracovávame?",
  "consent.data1": "Hlasový záznam. Zvukový súbor odoslaný do OpenAI Whisper prostredníctvom nášho servera na prepis. Súbor nie je po spracovaní uložený na serveri.",
  "consent.data2": "Prepis hlasu (text). Odoslané do OpenAI GPT na vyplnenie formulára. V predvolenom nastavení prepis neukladáme v našich systémoch; v technických protokoloch ukladáme len metaúdaje (dĺžka textu, jazyk, trvanie). Dôležité: OpenAI môže ukladať údaje požiadaviek až 30 dní na prevenciu zneužitia; skoré vymazanie v OpenAI nie je k dispozícii; údaje sa nepoužívajú na trénovanie modelov.",
  "consent.data3": "Metaúdaje polí formulára. Názvy/typy/zástupné znaky (citlivé polia vylúčené).",
  "consent.data4": "URL stránky. Spracované našou infraštruktúrou (na kompatibilitu/diagnostiku), NIE je odoslané do OpenAI. Prosím vyhýbajte sa osobným údajom v parametroch dotazu URL.",
  "consent.data5": "User-Agent prehliadača. Používaný lokálne a našou infraštruktúrou (kompatibilita/zabezpečenie), NIE je odoslaný do OpenAI.",
  "consent.data6": "IP adresa. Zaznamenaná infraštruktúrou Google Cloud/Firebase na zabezpečenie (až 30 dní), NIE je odoslaná do OpenAI.",
  "consent.section2_title": "Kam a na akom právnom základe sa údaje prenášajú?",
  "consent.recipients": "Príjemcovia. OpenAI (USA) — spracovanie zvuku/textu; Google Cloud/Firebase (EÚ/Poľsko) — hosting a protokoly zabezpečenia. Údaje sa nepoužívajú na trénovanie modelov.",
  "consent.transfer1": "OpenAI (USA). Požiadavky na OpenAI (vrátane zvuku/textu) môžu byť OpenAI uložené až 30 dní na prevenciu zneužitia; údaje sa nepoužívajú na trénovanie modelov. Prenos do USA — na základe SCC schválených Európskou komisiou.",
  "consent.basis_title": "Právne základy:",
  "consent.basis1": "Hlasová funkcia — váš súhlas (čl. 6 ods. 1 písm. a) GDPR).",
  "consent.basis2": "Technické protokoly (IP/UA/URL) — oprávnené záujmy (čl. 6 ods. 1 písm. f)) — zabezpečenie a ladenie.",
  "consent.section3_title": "Vaše práva",
  "consent.rights1": "Súhlas môžete kedykoľvek odvolať v nastaveniach widgetu; to neovplyvňuje zákonnosť spracovania pred odvolaním.",
  "consent.rights2": "Okrem odvolania súhlasu máte právo požiadať o prístup alebo vymazanie vašich údajov uložených v našich systémoch (technické protokoly, nákladové metriky) prostredníctvom majiteľa webu. Úplné podrobnosti v <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Zásadách ochrany osobných údajov</a>.",
  "consent.rights3": "Táto funkcia je určená pre používateľov 16+; pre mladších používateľov sa vyžaduje súhlas rodiča/opatrovníka.",
  "consent.footer_legal_title": "Právne Informácie",
  "consent.footer_controller": "Správca údajov: majiteľ tejto webovej stránky.",
  "consent.footer_processor": "TypelessForm: koná ako spracovateľ.",
  "consent.footer_contact": "Kontakt pre ochranu osobných údajov: info@webappski.com.",
  "consent.footer_sccs": "Prenos do USA sa vykonáva na základe SCC. Podrobnosti sú k dispozícii v našich <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Zásadách ochrany osobných údajov</a>.",
...
//# sourceMappingURL=sk-CmPrizsM-UYC3S5SI.js.map
