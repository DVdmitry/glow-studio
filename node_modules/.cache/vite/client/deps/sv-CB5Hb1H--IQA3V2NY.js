// node_modules/typelessform-widget/dist/sv-CB5Hb1H-.js
var e = {
  "modal.title": "Berätta om dessa ämnen",
  "modal.subtitle": "Vi förstår alla språk, fyller i allt och översätter vid behov",
  ...
  "error.lowConfidence": "Kunde inte förstå ljudet tydligt. Vänligen tala tydligare.",
  "error.general": "Något gick fel. Försök igen.",
  "error.domainNotAllowed": "Denna domän är inte auktoriserad att använda tjänsten. Kontakta webbplatsens administratör.",
  ...
  "error.no_fields_detected": "Kunde inte känna igen information för att fylla i formuläret. Försök att tydligare ange vilka data som ska matas in i fälten.",
  ...
  "consent.subtitle": "Läs noggrant informationen om skyddet av dina uppgifter",
  "consent.warning_title": "Viktigt: Dela Inte Känsliga Uppgifter",
  "consent.warning": "Vänligen nämn inte lösenord, betalningsuppgifter, myndighetsidentifierare eller medicinsk information. Dessa uppgifter är inte avsedda för behandling av röstfunktionen.",
  "consent.summary_card1_title": "Vad Vi Samlar In",
  "consent.summary_data1": "Röstinspelning → konverterad till text",
  "consent.summary_data2": "Fältnamn/typer/platshållare (utan värden; känsliga fält uteslutna)",
  "consent.summary_data3": "Tekniska loggar (IP, webbläsarinfo)",
  "consent.summary_card2_title": "Vart Det Går",
  "consent.summary_transfer": "OpenAI (USA) för AI-behandling • Google Cloud/Firebase (EU, Polen) för hosting och säkerhet",
  "consent.summary_card3_title": "Dina Rättigheter",
  "consent.summary_rights": "Återkalla samtycke när som helst • Begär åtkomst eller radering av dina uppgifter • Fullständig information i <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Integritetspolicy</a>",
  "consent.full_details_title": "Läs Fullständiga Detaljer",
  "consent.section1_title": "Vilka uppgifter behandlar vi?",
  "consent.data1": "Röstinspelning. Ljudfil skickas till OpenAI Whisper via vår server för transkribering. Filen sparas inte på servern efter behandling.",
  "consent.data2": "Rösttranskription (text). Skickas till OpenAI GPT för formulärfyllning. Som standard sparar vi inte transkriptionen i våra system; i tekniska loggar lagrar vi endast metadata (textlängd, språk, varaktighet). Viktigt: OpenAI kan lagra förfrågningsdata i upp till 30 dagar för att förhindra missbruk; tidig radering hos OpenAI är inte tillgänglig; data används inte för modellträning.",
  "consent.data3": "Formulärfältsmetadata. Namn/typer/platshållare (känsliga fält uteslutna).",
  "consent.data4": "Sidans URL. Behandlas av vår infrastruktur (för kompatibilitet/diagnostik), INTE skickat till OpenAI. Undvik personuppgifter i URL-frågeparametrar.",
  "consent.data5": "Webbläsarens User-Agent. Används lokalt och av vår infrastruktur (kompatibilitet/säkerhet), INTE skickat till OpenAI.",
  "consent.data6": "IP-adress. Loggad av Google Cloud/Firebase-infrastruktur för säkerhet (upp till 30 dagar), INTE skickat till OpenAI.",
  "consent.section2_title": "Vart och på vilken rättslig grund överförs uppgifter?",
  "consent.recipients": "Mottagare. OpenAI (USA) — ljud-/textbehandling; Google Cloud/Firebase (EU/Polen) — hosting och säkerhetsloggar. Data används inte för modellträning.",
  "consent.transfer1": "OpenAI (USA). Förfrågningar till OpenAI (inklusive ljud/text) kan lagras av OpenAI i upp till 30 dagar för att förhindra missbruk; data används inte för modellträning. Överföring till USA — baserad på SCC godkända av Europeiska kommissionen.",
  "consent.basis_title": "Rättsliga grunder:",
  "consent.basis1": "Röstfunktion — ditt samtycke (Art. 6(1)(a) GDPR).",
  "consent.basis2": "Tekniska loggar (IP/UA/URL) — berättigade intressen (Art. 6(1)(f)) — säkerhet och felsökning.",
  "consent.section3_title": "Dina rättigheter",
  "consent.rights1": "Du kan återkalla samtycke i widgetinställningar när som helst; detta påverkar inte lagligheten av behandling före återkallelse.",
  "consent.rights2": "Förutom att återkalla samtycke har du rätt att begära åtkomst eller radering av dina uppgifter lagrade i våra system (tekniska loggar, kostnadsmått) via webbplatsägaren. Fullständig information i <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Integritetspolicy</a>.",
  "consent.rights3": "Denna funktion är avsedd för användare 16+; för yngre användare krävs förälders/vårdnadshavares samtycke.",
  "consent.footer_legal_title": "Juridisk Information",
  "consent.footer_controller": "Personuppgiftsansvarig: ägaren av denna webbplats.",
  "consent.footer_processor": "TypelessForm: agerar som personuppgiftsbiträde.",
  "consent.footer_contact": "Integritetskontakt: info@webappski.com.",
  "consent.footer_sccs": "Överföring till USA genomförs enligt SCC. Detaljer finns i vår <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Integritetspolicy</a>.",
...
//# sourceMappingURL=sv-CB5Hb1H--IQA3V2NY.js.map
