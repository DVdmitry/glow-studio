// node_modules/typelessform-widget/dist/pl-CUe0ZIDw.js
var e = {
  "modal.title": "Opowiedz nam o tych tematach",
  "modal.subtitle": "Rozumiemy każdy język, wypełnimy wszystko i przetłumaczymy w razie potrzeby",
  ...
  "error.lowConfidence": "Nie można było wyraźnie zrozumieć audio. Proszę mówić wyraźniej.",
  "error.general": "Coś poszło nie tak. Spróbuj ponownie.",
  "error.domainNotAllowed": "Ta domena nie jest upoważniona do korzystania z usługi. Skontaktuj się z administratorem witryny.",
  "error.serviceUnavailable": "Usługa tymczasowo niedostępna. Spróbuj ponownie później lub skontaktuj się z administratorem witryny.",
  ...
  "error.no_fields_detected": "Nie udało się rozpoznać informacji do wypełnienia formularza. Spróbuj dokładniej określić, jakie dane należy wprowadzić w pola.",
  ...
  "consent.subtitle": "Prosimy o uważne przeczytanie informacji o ochronie Twoich danych",
  "consent.warning_title": "Ważne: Nie Udostępniaj Danych Wrażliwych",
  "consent.warning": "Proszę nie wymawiać haseł, danych płatności, identyfikatorów rządowych ani informacji medycznych. Te dane nie są przeznaczone do przetwarzania przez funkcję głosową.",
  "consent.summary_card1_title": "Co Zbieramy",
  "consent.summary_data1": "Nagranie głosowe → przekonwertowane na tekst",
  "consent.summary_data2": "Nazwy/typy/podpowiedzi pól (bez wartości; pola wrażliwe wyłączone)",
  "consent.summary_data3": "Logi techniczne (IP, informacje o przeglądarce)",
  "consent.summary_card2_title": "Gdzie Trafia",
  "consent.summary_transfer": "OpenAI (USA) do przetwarzania AI • Google Cloud/Firebase (UE, Polska) do hostingu i bezpieczeństwa",
  "consent.summary_card3_title": "Twoje Prawa",
  "consent.summary_rights": "Cofnij zgodę w dowolnym momencie • Żądaj dostępu lub usunięcia Twoich danych • Pełne szczegóły w <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Polityce Prywatności</a>",
  "consent.full_details_title": "Przeczytaj Pełne Szczegóły",
  "consent.section1_title": "Jakie dane przetwarzamy?",
  "consent.data1": "Nagranie głosowe. Plik audio wysyłany do OpenAI Whisper przez nasz serwer w celu transkrypcji. Plik nie jest zapisywany na serwerze po przetworzeniu.",
  "consent.data2": "Transkrypcja głosu (tekst). Wysyłana do OpenAI GPT w celu wypełniania formularzy. Domyślnie nie zapisujemy transkrypcji w naszych systemach; w logach technicznych przechowujemy tylko metadane (długość tekstu, język, czas trwania). Ważne: OpenAI może przechowywać dane żądań do 30 dni w celu zapobiegania nadużyciom; wcześniejsze usunięcie w OpenAI nie jest dostępne; dane nie są wykorzystywane do trenowania modeli.",
  "consent.data3": "Metadane pól formularza. Nazwy/typy/podpowiedzi (pola wrażliwe wyłączone).",
  "consent.data4": "URL strony. Przetwarzany przez naszą infrastrukturę (w celu kompatybilności/diagnostyki), NIE wysyłany do OpenAI. Proszę unikać danych osobowych w parametrach zapytań URL.",
  "consent.data5": "User-Agent przeglądarki. Używany lokalnie i przez naszą infrastrukturę (kompatybilność/bezpieczeństwo), NIE wysyłany do OpenAI.",
  "consent.data6": "Adres IP. Rejestrowany przez infrastrukturę Google Cloud/Firebase w celach bezpieczeństwa (do 30 dni), NIE wysyłany do OpenAI.",
  "consent.section2_title": "Gdzie i na jakiej podstawie prawnej dane są przekazywane?",
  "consent.recipients": "Odbiorcy. OpenAI (USA) — przetwarzanie audio/tekstu; Google Cloud/Firebase (UE/Polska) — hosting i logi bezpieczeństwa. Dane nie są wykorzystywane do trenowania modeli.",
  "consent.transfer1": "OpenAI (USA). Żądania do OpenAI (w tym audio/tekst) mogą być przechowywane przez OpenAI do 30 dni w celu zapobiegania nadużyciom; dane nie są wykorzystywane do trenowania modeli. Transfer do USA — na podstawie SCC zatwierdzonych przez Komisję Europejską.",
  "consent.basis_title": "Podstawy prawne:",
  "consent.basis1": "Funkcja głosowa — Twoja zgoda (Art. 6(1)(a) RODO).",
  "consent.basis2": "Logi techniczne (IP/UA/URL) — prawnie uzasadnione interesy (Art. 6(1)(f)) — bezpieczeństwo i debugowanie.",
  "consent.section3_title": "Twoje prawa",
  "consent.rights1": "Możesz cofnąć zgodę w ustawieniach widgetu w dowolnym momencie; nie wpływa to na zgodność z prawem przetwarzania przed cofnięciem.",
  "consent.rights2": "Oprócz cofnięcia zgody masz prawo żądać dostępu lub usunięcia Twoich danych przechowywanych w naszych systemach (logi techniczne, metryki kosztów) za pośrednictwem właściciela witryny. Pełne szczegóły w <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Polityce Prywatności</a>.",
  "consent.rights3": "Ta funkcja jest przeznaczona dla użytkowników w wieku 16+; dla młodszych użytkowników wymagana jest zgoda rodziców/opiekunów.",
  "consent.footer_legal_title": "Informacje Prawne",
  "consent.footer_controller": "Administrator danych: właściciel tej witryny.",
  "consent.footer_processor": "TypelessForm: działa jako procesor.",
  "consent.footer_contact": "Kontakt w sprawie prywatności: info@webappski.com.",
  "consent.footer_sccs": "Transfer do USA odbywa się na podstawie SCC. Szczegóły dostępne w naszej <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Polityce Prywatności</a>.",
...
//# sourceMappingURL=pl-CUe0ZIDw-H2TOLK3G.js.map
