// node_modules/typelessform-widget/dist/ja-Dst6QgDK.js
var e = {
  "modal.title": "これらのトピックについて教えてください",
  "modal.subtitle": "どの言語でも理解し、必要に応じてすべてを入力し翻訳します",
  ...
  "success.subtitle": "入力されたフィールドを確認し、準備ができたら送信してください",
  ...
  "error.lowConfidence": "音声を明確に理解できませんでした。もっとはっきりと話してください。",
  "error.general": "問題が発生しました。もう一度お試しください。",
  "error.domainNotAllowed": "このドメインはサービスの使用を許可されていません。ウェブサイト管理者にお問い合わせください。",
  "error.serviceUnavailable": "サービスは一時的に利用できません。後でもう一度お試しいただくか、ウェブサイト管理者にお問い合わせください。",
  ...
  "error.no_fields_detected": "フォームに入力する情報を認識できませんでした。フィールドに入力すべきデータをより明確に指定してください。",
  ...
  "consent.warning": "パスワード、支払い詳細、政府発行の識別子、医療情報は述べないでください。このデータは音声機能による処理を意図していません。",
  "consent.summary_card1_title": "収集するもの",
  "consent.summary_data1": "音声録音 → テキストに変換",
  "consent.summary_data2": "フィールド名/タイプ/プレースホルダー(値なし;機密フィールドは除外)",
  "consent.summary_data3": "技術ログ(IP、ブラウザ情報)",
  "consent.summary_card2_title": "データの送信先",
  "consent.summary_transfer": "OpenAI(米国)AI処理用 • Google Cloud/Firebase(EU、ポーランド)ホスティングとセキュリティ用",
  "consent.summary_card3_title": "あなたの権利",
  "consent.summary_rights": "いつでも同意を撤回 • データへのアクセスまたは削除を要求 • <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>プライバシーポリシー</a>の詳細",
  "consent.full_details_title": "詳細を読む",
  "consent.section1_title": "処理するデータは何ですか?",
  "consent.data1": "音声録音。オーディオファイルは、転写のために当社のサーバー経由でOpenAI Whisperに送信されます。ファイルは処理後、サーバーに保存されません。",
  "consent.data2": "音声転写(テキスト)。フォーム入力のためにOpenAI GPTに送信されます。デフォルトでは、システムに転写を保存しません。技術ログにはメタデータ(テキスト長、言語、期間)のみを保存します。重要:OpenAIは不正使用防止のため最大30日間リクエストデータを保存する場合があります。OpenAIでの早期削除は利用できません。データはモデルトレーニングには使用されません。",
  "consent.data3": "フォームフィールドのメタデータ。名前/タイプ/プレースホルダー(機密フィールドは除外)。",
  "consent.data4": "ページURL。当社のインフラストラクチャで処理されます(互換性/診断用)。OpenAIには送信されません。URLクエリパラメータに個人データを含めないでください。",
  "consent.data5": "ブラウザUser-Agent。ローカルおよび当社のインフラストラクチャで使用されます(互換性/セキュリティ)。OpenAIには送信されません。",
  "consent.data6": "IPアドレス。セキュリティのためGoogle Cloud/Firebaseインフラストラクチャで記録されます(最大30日)。OpenAIには送信されません。",
  "consent.section2_title": "データはどこに、どのような法的根拠で転送されますか?",
  "consent.recipients": "受信者。OpenAI(米国)—オーディオ/テキスト処理。Google Cloud/Firebase(EU/ポーランド)—ホスティングとセキュリティログ。データはモデルトレーニングには使用されません。",
  "consent.transfer1": "OpenAI(米国)。OpenAIへのリクエスト(オーディオ/テキストを含む)は、不正使用防止のため最大30日間OpenAIによって保存される場合があります。データはモデルトレーニングには使用されません。米国への転送—欧州委員会承認のSCCに基づきます。",
  "consent.basis_title": "法的根拠:",
  "consent.basis1": "音声機能—お客様の同意(GDPR第6(1)(a)条)。",
  "consent.basis2": "技術ログ(IP/UA/URL)—正当な利益(第6(1)(f)条)—セキュリティとデバッグ。",
  "consent.section3_title": "あなたの権利",
  "consent.rights1": "ウィジェット設定でいつでも同意を撤回できます。撤回前の処理の合法性には影響しません。",
  "consent.rights2": "同意の撤回に加えて、ウェブサイト所有者を通じて、当社のシステムに保存されているデータ(技術ログ、コストメトリクス)へのアクセスまたは削除を要求する権利があります。<a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>プライバシーポリシー</a>の詳細をご覧ください。",
  "consent.rights3": "この機能は16歳以上のユーザーを対象としています。若いユーザーには保護者/後見人の同意が必要です。",
  ...
  "consent.footer_sccs": "米国への転送はSCCの下で実施されます。詳細は当社の<a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>プライバシーポリシー</a>でご確認いただけます。",
...
//# sourceMappingURL=ja-Dst6QgDK-UGBGASXS.js.map
