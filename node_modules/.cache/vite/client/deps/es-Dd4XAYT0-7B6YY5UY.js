// node_modules/typelessform-widget/dist/es-Dd4XAYT0.js
var e = {
  "modal.title": "Cuéntanos sobre estos temas",
  "modal.subtitle": "Entendemos cualquier idioma, completa todo y traduce si es necesario",
  ...
  "success.subtitle": "Revisa los campos rellenados y envía cuando estés listo",
  ...
  "error.lowConfidence": "No se pudo entender claramente el audio. Por favor, habla más claramente.",
  "error.general": "Algo salió mal. Por favor, inténtalo de nuevo.",
  "error.domainNotAllowed": "Este dominio no está autorizado para usar el servicio. Por favor, contacte al administrador del sitio web.",
  "error.serviceUnavailable": "Servicio temporalmente no disponible. Por favor, inténtelo más tarde o contacte al administrador del sitio web.",
  ...
  "error.no_fields_detected": "No se pudo reconocer información para rellenar el formulario. Por favor, intenta especificar más claramente qué datos deben ingresarse en los campos.",
  ...
  "consent.subtitle": "Por favor, lea atentamente la información sobre la protección de sus datos",
  "consent.warning_title": "Importante: No Comparta Datos Sensibles",
  "consent.warning": "Por favor, no mencione contraseñas, detalles de pago, identificadores gubernamentales o información médica. Estos datos no están destinados a ser procesados por la función de voz.",
  "consent.summary_card1_title": "Qué Recopilamos",
  "consent.summary_data1": "Grabación de voz → convertida a texto",
  "consent.summary_data2": "Nombres/tipos/marcadores de posición de campos (sin valores; campos sensibles excluidos)",
  "consent.summary_data3": "Registros técnicos (IP, información del navegador)",
  "consent.summary_card2_title": "A Dónde Va",
  "consent.summary_transfer": "OpenAI (EE.UU.) para procesamiento de IA • Google Cloud/Firebase (UE, Polonia) para alojamiento y seguridad",
  "consent.summary_card3_title": "Sus Derechos",
  "consent.summary_rights": "Retirar consentimiento en cualquier momento • Solicitar acceso o eliminación de sus datos • Detalles completos en la <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Política de Privacidad</a>",
  "consent.full_details_title": "Leer Detalles Completos",
  "consent.section1_title": "¿Qué datos procesamos?",
  "consent.data1": "Grabación de voz. Archivo de audio enviado a OpenAI Whisper a través de nuestro servidor para transcripción. El archivo no se guarda en el servidor después del procesamiento.",
  "consent.data2": "Transcripción de voz (texto). Enviada a OpenAI GPT para completar formularios. Por defecto, no guardamos la transcripción en nuestros sistemas; en los registros técnicos almacenamos solo metadatos (longitud del texto, idioma, duración). Importante: OpenAI puede almacenar datos de solicitud hasta 30 días para prevenir abusos; la eliminación anticipada en OpenAI no está disponible; los datos no se utilizan para entrenar modelos.",
  "consent.data3": "Metadatos de campos de formulario. Nombres/tipos/marcadores de posición (campos sensibles excluidos).",
  "consent.data4": "URL de la página. Procesada por nuestra infraestructura (para compatibilidad/diagnósticos), NO enviada a OpenAI. Por favor, evite datos personales en parámetros de consulta de URL.",
  "consent.data5": "User-Agent del navegador. Utilizado localmente y por nuestra infraestructura (compatibilidad/seguridad), NO enviado a OpenAI.",
  "consent.data6": "Dirección IP. Registrada por la infraestructura de Google Cloud/Firebase para seguridad (hasta 30 días), NO enviada a OpenAI.",
  "consent.section2_title": "¿A dónde y sobre qué base legal se transfieren los datos?",
  "consent.recipients": "Destinatarios. OpenAI (EE.UU.) — procesamiento de audio/texto; Google Cloud/Firebase (UE/Polonia) — alojamiento y registros de seguridad. Los datos no se utilizan para entrenar modelos.",
  "consent.transfer1": "OpenAI (EE.UU.). Las solicitudes a OpenAI (incluyendo audio/texto) pueden ser almacenadas por OpenAI hasta 30 días para prevenir abusos; los datos no se utilizan para entrenar modelos. Transferencia a EE.UU. — basada en SCC aprobadas por la Comisión Europea.",
  "consent.basis_title": "Bases legales:",
  "consent.basis1": "Función de voz — su consentimiento (Art. 6(1)(a) RGPD).",
  "consent.basis2": "Registros técnicos (IP/UA/URL) — intereses legítimos (Art. 6(1)(f)) — seguridad y depuración.",
  "consent.section3_title": "Sus derechos",
  "consent.rights1": "Puede retirar el consentimiento en la configuración del widget en cualquier momento; esto no afecta la legalidad del procesamiento antes de la retirada.",
  "consent.rights2": "Además de retirar el consentimiento, tiene derecho a solicitar acceso o eliminación de sus datos almacenados en nuestros sistemas (registros técnicos, métricas de costos) a través del propietario del sitio web. Detalles completos en la <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Política de Privacidad</a>.",
  "consent.rights3": "Esta función está destinada a usuarios de 16+; para usuarios más jóvenes, se requiere el consentimiento de padres/tutores.",
  "consent.footer_legal_title": "Información Legal",
  "consent.footer_controller": "Responsable del Tratamiento: el propietario de este sitio web.",
  "consent.footer_processor": "TypelessForm: actúa como encargado del tratamiento.",
  "consent.footer_contact": "Contacto de privacidad: info@webappski.com.",
  "consent.footer_sccs": "La transferencia a EE.UU. se realiza bajo SCC. Los detalles están disponibles en nuestra <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Política de Privacidad</a>.",
...
//# sourceMappingURL=es-Dd4XAYT0-7B6YY5UY.js.map
