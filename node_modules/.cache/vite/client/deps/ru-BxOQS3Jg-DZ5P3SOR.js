// node_modules/typelessform-widget/dist/ru-BxOQS3Jg.js
var e = {
  "modal.title": "Расскажите об этих темах",
  "modal.subtitle": "Мы поймём любой язык, всё заполним и, если нужно, переведём",
  ...
  "error.lowConfidence": "Не удалось четко распознать речь. Пожалуйста, говорите более отчетливо.",
  "error.general": "Что-то пошло не так. Попробуйте еще раз.",
  "error.domainNotAllowed": "Этот домен не авторизован для использования сервиса. Обратитесь к администратору сайта.",
  "error.serviceUnavailable": "Сервис временно недоступен. Пожалуйста, попробуйте позже или обратитесь к администратору сайта.",
  "error.invalidApiKey": "Сервис некорректно настроен. Обратитесь к администратору сайта.",
  ...
  "error.no_fields_detected": "Не удалось распознать информацию для заполнения формы. Попробуйте четче указать, какие данные нужно ввести в поля.",
  ...
  "consent.subtitle": "Пожалуйста, внимательно прочитайте информацию о защите ваших данных",
  // Anti-PII warning (hero banner)
  "consent.warning_title": "Важно: Не сообщайте конфиденциальные данные",
  "consent.warning": "Пожалуйста, не произносите пароли, платёжные данные, гос-идентификаторы и медицинскую информацию. Эти данные не предназначены для обработки голосовой функцией.",
  // Summary cards (always visible)
  "consent.summary_card1_title": "Что мы собираем",
  "consent.summary_data1": "Голосовая запись → преобразуется в текст",
  "consent.summary_data2": "Названия/типы/подсказки полей (без значений; чувствительные поля исключаем)",
  "consent.summary_data3": "Технические логи (IP, информация о браузере)",
  "consent.summary_card2_title": "Куда передаются данные",
  "consent.summary_transfer": "OpenAI (США) для AI-обработки • Google Cloud/Firebase (ЕС, Польша) для хостинга и безопасности",
  "consent.summary_card3_title": "Ваши права",
  "consent.summary_rights": "Отозвать согласие в любой момент • Запросить доступ или удаление ваших данных • Подробности в <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Политике конфиденциальности</a>",
  ...
  "consent.data1": "Голосовая запись. Аудиофайл отправляется на OpenAI Whisper через наш сервер для транскрибации. Файл не сохраняется на сервере после обработки.",
  "consent.data2": "Транскрипт голоса (текст). Отправляется в OpenAI GPT для заполнения формы. Мы не храним транскрипт на наших серверах; он обрабатывается в памяти и удаляется после ответа. Мы логируем только технические метаданные (длина, язык, длительность). Важно: OpenAI может хранить данные запроса до 30 дней для предотвращения злоупотреблений; досрочное удаление у OpenAI недоступно; данные не используются для обучения моделей.",
  "consent.data3": "Метаданные полей формы. Названия/типы/подсказки (чувствительные поля исключаем).",
  "consent.data4": "URL страницы. Обрабатывается нашей инфраструктурой (для совместимости/диагностики), в OpenAI не передаётся. Пожалуйста, избегайте персональных данных в query-параметрах URL.",
  "consent.data5": "User-Agent браузера. Используется локально и нашей инфраструктурой (совместимость/безопасность), в OpenAI не передаётся.",
  "consent.data6": "IP-адрес. Логируется инфраструктурой Google Cloud/Firebase для безопасности (до 30 дней), в OpenAI не передаётся.",
  // Section 2: Where and on what basis
  "consent.section2_title": "Куда и на каком основании передаются данные?",
  "consent.recipients": "Получатели. OpenAI (США) — обработка аудио/текста; Google Cloud/Firebase (ЕС/Польша) — хостинг и логи безопасности. Данные не используются для обучения моделей.",
  "consent.transfer1": "OpenAI (США). Запросы к OpenAI (включая аудио/текст) могут храниться у OpenAI до 30 дней для предотвращения злоупотреблений; данные не используются для обучения моделей. Передача в США — на основе SCCs, утверждённых Европейской Комиссией.",
  "consent.basis_title": "Правовые основания:",
  "consent.basis1": "Голосовая функция — ваше согласие (Art. 6(1)(a) GDPR).",
  "consent.basis2": "Технические логи (IP/UA/URL) — законные интересы (Art. 6(1)(f)) — безопасность и отладка.",
  // Section 3: Your rights
  "consent.section3_title": "Ваши права",
  "consent.rights1": "Вы можете отозвать согласие в настройках виджета в любой момент; это не влияет на законность обработки до отзыва.",
  "consent.rights2": "Кроме отзыва согласия, вы имеете право запросить доступ или удаление ваших данных, хранящихся в наших системах (технические логи и метрики использования), через владельца сайта. Подробности в <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Политике конфиденциальности</a>.",
  "consent.rights3": "Функция предназначена для пользователей 16+; для младше требуется согласие родителя/опекуна.",
  // Footer legal info
  "consent.footer_legal_title": "Юридическая информация",
  "consent.footer_controller": "Контроллер данных: владелец этого сайта.",
  "consent.footer_processor": "TypelessForm: выступает как обработчик (processor).",
  "consent.footer_contact": "Контакты по приватности: info@webappski.com.",
  "consent.footer_sccs": "Передача в США осуществляется по SCCs. С деталями можно ознакомиться в нашей <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Политике конфиденциальности</a>.",
...
//# sourceMappingURL=ru-BxOQS3Jg-DZ5P3SOR.js.map
