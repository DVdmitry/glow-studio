// node_modules/typelessform-widget/dist/no-DU6wQP8Z.js
var e = {
  "modal.title": "Fortell oss om disse emnene",
  "modal.subtitle": "Vi forstår alle språk, fyller ut alt og oversetter om nødvendig",
  ...
  "success.subtitle": "Gå gjennom de utfylte feltene og send inn når du er klar",
  ...
  "error.lowConfidence": "Kunne ikke forstå lyden tydelig. Vennligst snakk tydeligere.",
  "error.general": "Noe gikk galt. Vennligst prøv igjen.",
  "error.domainNotAllowed": "Dette domenet er ikke autorisert til å bruke tjenesten. Vennligst kontakt nettstedets administrator.",
  ...
  "error.no_fields_detected": "Kunne ikke gjenkjenne informasjon for å fylle ut skjemaet. Vennligst prøv å spesifisere tydeligere hvilke data som skal skrives inn i feltene.",
  ...
  "consent.subtitle": "Vennligst les informasjonen om databeskyttelsen din nøye",
  "consent.warning_title": "Viktig: Ikke Del Sensitive Data",
  "consent.warning": "Vennligst ikke nevn passord, betalingsdetaljer, myndighetidentifikatorer eller medisinsk informasjon. Disse dataene er ikke ment for behandling av stemmefunksjonen.",
  "consent.summary_card1_title": "Hva Vi Samler Inn",
  "consent.summary_data1": "Stemmeoppptak → konvertert til tekst",
  "consent.summary_data2": "Feltnavn/typer/plassholdere (uten verdier; sensitive felt ekskludert)",
  "consent.summary_data3": "Tekniske logger (IP, nettleserinfo)",
  "consent.summary_card2_title": "Hvor Det Går",
  "consent.summary_transfer": "OpenAI (USA) for AI-behandling • Google Cloud/Firebase (EU, Polen) for hosting og sikkerhet",
  "consent.summary_card3_title": "Dine Rettigheter",
  "consent.summary_rights": "Trekk tilbake samtykke når som helst • Be om tilgang eller sletting av dataene dine • Fullstendige detaljer i <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Personvernregler</a>",
  "consent.full_details_title": "Les Fullstendige Detaljer",
  "consent.section1_title": "Hvilke data behandler vi?",
  "consent.data1": "Stemmeoppptak. Lydfil sendt til OpenAI Whisper via vår server for transkripsjon. Filen lagres ikke på serveren etter behandling.",
  "consent.data2": "Stemmetranskripsjon (tekst). Sendt til OpenAI GPT for utfylling av skjema. Som standard lagrer vi ikke transkripsjonen i våre systemer; i tekniske logger lagrer vi kun metadata (tekstlengde, språk, varighet). Viktig: OpenAI kan lagre forespørselsdata i opptil 30 dager for å forhindre misbruk; tidlig sletting hos OpenAI er ikke tilgjengelig; data brukes ikke til modelltrening.",
  "consent.data3": "Skjemafeltmetadata. Navn/typer/plassholdere (sensitive felt ekskludert).",
  "consent.data4": "Side-URL. Behandlet av vår infrastruktur (for kompatibilitet/diagnostikk), IKKE sendt til OpenAI. Vennligst unngå personlige data i URL-spørringsparametere.",
  "consent.data5": "Nettleser User-Agent. Brukt lokalt og av vår infrastruktur (kompatibilitet/sikkerhet), IKKE sendt til OpenAI.",
  "consent.data6": "IP-adresse. Logget av Google Cloud/Firebase-infrastruktur for sikkerhet (opptil 30 dager), IKKE sendt til OpenAI.",
  "consent.section2_title": "Hvor og på hvilket rettslig grunnlag overføres data?",
  "consent.recipients": "Mottakere. OpenAI (USA) — lyd-/tekstbehandling; Google Cloud/Firebase (EU/Polen) — hosting og sikkerhetlogger. Data brukes ikke til modelltrening.",
  "consent.transfer1": "OpenAI (USA). Forespørsler til OpenAI (inkludert lyd/tekst) kan lagres av OpenAI i opptil 30 dager for å forhindre misbruk; data brukes ikke til modelltrening. Overføring til USA — basert på SCC godkjent av EU-kommisjonen.",
  "consent.basis_title": "Rettslig grunnlag:",
  "consent.basis1": "Stemmefunksjon — ditt samtykke (Art. 6(1)(a) GDPR).",
  "consent.basis2": "Tekniske logger (IP/UA/URL) — legitime interesser (Art. 6(1)(f)) — sikkerhet og feilsøking.",
  "consent.section3_title": "Dine rettigheter",
  "consent.rights1": "Du kan trekke tilbake samtykke i widgetinnstillinger når som helst; dette påvirker ikke lovligheten av behandling før tilbaketrekning.",
  "consent.rights2": "I tillegg til å trekke tilbake samtykke har du rett til å be om tilgang eller sletting av dataene dine lagret i våre systemer (tekniske logger, kostnadsmålinger) via nettstedeieren. Fullstendige detaljer i <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Personvernregler</a>.",
  "consent.rights3": "Denne funksjonen er ment for brukere 16+; for yngre brukere kreves foreldres/verges samtykke.",
  ...
  "consent.footer_sccs": "Overføring til USA utføres under SCC. Detaljer er tilgjengelige i våre <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Personvernregler</a>.",
...
//# sourceMappingURL=no-DU6wQP8Z-AB3VVV4G.js.map
