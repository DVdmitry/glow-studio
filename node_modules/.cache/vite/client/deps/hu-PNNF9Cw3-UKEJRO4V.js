// node_modules/typelessform-widget/dist/hu-PNNF9Cw3.js
var e = {
  "modal.title": "Mondd el nekünk ezeket a témákat",
  "modal.subtitle": "Bármely nyelvet értünk, mindent kitöltünk, és ha kell, fordítunk",
  ...
  "listening.subtitle": "Beszélj természetesen arról, amit ki szeretnél tölteni",
  ...
  "success.subtitle": "Ellenőrizd a kitöltött mezőket, és küldd el, ha készen állsz",
  ...
  "error.lowConfidence": "Nem sikerült tisztán érteni a hangot. Kérlek, beszélj érthetőbben.",
  "error.general": "Valami elromlott. Kérlek, próbáld újra.",
  "error.domainNotAllowed": "Ez a domain nem jogosult a szolgáltatás használatára. Kérjük, vegye fel a kapcsolatot a weboldal adminisztrátorával.",
  ...
  "error.no_fields_detected": "Nem sikerült felismerni az űrlap kitöltéséhez szükséges információkat. Kérjük, próbálja meg világosabban megadni, hogy milyen adatokat kell beírni a mezőkbe.",
  ...
  "consent.subtitle": "Kérjük, figyelmesen olvassa el az adatvédelmével kapcsolatos információkat",
  "consent.warning_title": "Fontos: Ne Osszon Meg Érzékeny Adatokat",
  "consent.warning": "Kérjük, ne említsen jelszavakat, fizetési adatokat, kormányzati azonosítókat vagy egészségügyi információkat. Ezeket az adatokat nem szabad a hangfunkció feldolgozására használni.",
  "consent.summary_card1_title": "Mit Gyűjtünk",
  "consent.summary_data1": "Hangfelvétel → szöveggé alakítva",
  "consent.summary_data2": "Mezőnevek/típusok/helyőrzők (értékek nélkül; érzékeny mezők kizárva)",
  "consent.summary_data3": "Technikai naplók (IP, böngésző információ)",
  "consent.summary_card2_title": "Hová Kerül",
  "consent.summary_transfer": "OpenAI (USA) AI feldolgozáshoz • Google Cloud/Firebase (EU, Lengyelország) tárhely és biztonság",
  "consent.summary_card3_title": "Az Ön Jogai",
  "consent.summary_rights": "Bármikor visszavonhatja hozzájárulását • Kérheti adataihoz való hozzáférést vagy azok törlését • Teljes részletek az <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Adatvédelmi Szabályzatban</a>",
  "consent.full_details_title": "Teljes Részletek Olvasása",
  "consent.section1_title": "Milyen adatokat dolgozunk fel?",
  "consent.data1": "Hangfelvétel. Hangfájl elküldve az OpenAI Whispernek szerverünkön keresztül átíráshoz. A fájl nem kerül mentésre a szerveren feldolgozás után.",
  "consent.data2": "Hangátirat (szöveg). Elküldve az OpenAI GPT-nek űrlapkitöltéshez. Alapértelmezés szerint nem mentjük az átiratot rendszereinkben; technikai naplókban csak metaadatokat tárolunk (szöveghossz, nyelv, időtartam). Fontos: Az OpenAI akár 30 napig tárolhatja a kérésadatokat visszaélések megelőzésére; korai törlés az OpenAI-nál nem elérhető; az adatokat nem használják modellképzéshez.",
  "consent.data3": "Űrlapmező metaadatok. Nevek/típusok/helyőrzők (érzékeny mezők kizárva).",
  "consent.data4": "Oldal URL. Infrastruktúránk dolgozza fel (kompatibilitás/diagnosztika), NEM küldjük el az OpenAI-nak. Kérjük, kerülje a személyes adatokat az URL lekérdezési paramétereiben.",
  "consent.data5": "Böngésző User-Agent. Helyileg és infrastruktúránk használja (kompatibilitás/biztonság), NEM küldjük el az OpenAI-nak.",
  "consent.data6": "IP-cím. A Google Cloud/Firebase infrastruktúra naplózza biztonság érdekében (legfeljebb 30 napig), NEM küldjük el az OpenAI-nak.",
  "consent.section2_title": "Hová és milyen jogalappal kerülnek továbbításra az adatok?",
  "consent.recipients": "Címzettek. OpenAI (USA) — hang/szöveg feldolgozás; Google Cloud/Firebase (EU/Lengyelország) — tárhely és biztonsági naplók. Az adatokat nem használják modellképzéshez.",
  "consent.transfer1": "OpenAI (USA). Az OpenAI-hoz küldött kérések (beleértve a hangot/szöveget) az OpenAI akár 30 napig tárolhatja visszaélések megelőzésére; az adatokat nem használják modellképzéshez. USA-ba történő továbbítás — az Európai Bizottság által jóváhagyott SCC alapján.",
  "consent.basis_title": "Jogalapok:",
  "consent.basis1": "Hangfunkció — az Ön hozzájárulása (GDPR 6. cikk (1) bekezdés a) pont).",
  "consent.basis2": "Technikai naplók (IP/UA/URL) — jogos érdekek (6. cikk (1) bekezdés f) pont) — biztonság és hibakeresés.",
  "consent.section3_title": "Az Ön jogai",
  "consent.rights1": "Bármikor visszavonhatja hozzájárulását a widget beállításaiban; ez nem érinti a visszavonás előtti feldolgozás jogszerűségét.",
  "consent.rights2": "A hozzájárulás visszavonásán túl jogában áll kérni rendszereinkben tárolt adataihoz (technikai naplók, költségmutatók) való hozzáférést vagy azok törlését a webhely tulajdonosán keresztül. Teljes részletek az <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Adatvédelmi Szabályzatban</a>.",
  "consent.rights3": "Ez a funkció 16 év feletti felhasználóknak szól; fiatalabb felhasználók esetén szülői/gondviselői hozzájárulás szükséges.",
  "consent.footer_legal_title": "Jogi Információk",
  "consent.footer_controller": "Adatkezelő: ennek a weboldalnak a tulajdonosa.",
  ...
  "consent.footer_sccs": "Az USA-ba történő továbbítás SCC alapján történik. A részletek <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Adatvédelmi Szabályzatunkban</a> érhetők el.",
...
//# sourceMappingURL=hu-PNNF9Cw3-UKEJRO4V.js.map
