// node_modules/typelessform-widget/dist/fr-CNI53h-K.js
var e = {
  "modal.title": "Parlez-nous de ces sujets",
  "modal.subtitle": "Nous comprenons toutes les langues, remplissez tout et traduisez si nécessaire",
  ...
  "success.subtitle": "Vérifiez les champs remplis et envoyez lorsque vous êtes prêt",
  ...
  "error.lowConfidence": "Impossible de comprendre clairement l'audio. Veuillez parler plus clairement.",
  "error.general": "Une erreur est survenue. Veuillez réessayer.",
  "error.domainNotAllowed": "Ce domaine n'est pas autorisé à utiliser le service. Veuillez contacter l'administrateur du site web.",
  "error.serviceUnavailable": "Service temporairement indisponible. Veuillez réessayer plus tard ou contacter l'administrateur du site.",
  ...
  "error.no_fields_detected": "Impossible de reconnaître les informations pour remplir le formulaire. Veuillez essayer de spécifier plus clairement quelles données doivent être saisies dans les champs.",
  ...
  "consent.subtitle": "Veuillez lire attentivement les informations sur la protection de vos données",
  "consent.warning_title": "Important : Ne Partagez Pas de Données Sensibles",
  "consent.warning": "Veuillez ne pas mentionner de mots de passe, détails de paiement, identifiants gouvernementaux ou informations médicales. Ces données ne sont pas destinées à être traitées par la fonction vocale.",
  "consent.summary_card1_title": "Ce Que Nous Collectons",
  "consent.summary_data1": "Enregistrement vocal → converti en texte",
  "consent.summary_data2": "Noms/types/espaces réservés des champs (sans valeurs ; champs sensibles exclus)",
  "consent.summary_data3": "Journaux techniques (IP, informations du navigateur)",
  "consent.summary_card2_title": "Où Cela Va",
  "consent.summary_transfer": "OpenAI (États-Unis) pour le traitement IA • Google Cloud/Firebase (UE, Pologne) pour l'hébergement et la sécurité",
  "consent.summary_card3_title": "Vos Droits",
  "consent.summary_rights": "Retirer le consentement à tout moment • Demander l'accès ou la suppression de vos données • Détails complets dans la <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Politique de Confidentialité</a>",
  "consent.full_details_title": "Lire les Détails Complets",
  "consent.section1_title": "Quelles données traitons-nous ?",
  "consent.data1": "Enregistrement vocal. Fichier audio envoyé à OpenAI Whisper via notre serveur pour transcription. Le fichier n'est pas enregistré sur le serveur après traitement.",
  "consent.data2": "Transcription vocale (texte). Envoyée à OpenAI GPT pour remplir le formulaire. Par défaut, nous ne sauvegardons pas la transcription dans nos systèmes ; dans les journaux techniques, nous stockons uniquement des métadonnées (longueur du texte, langue, durée). Important : OpenAI peut stocker les données de requête jusqu'à 30 jours pour prévenir les abus ; la suppression anticipée chez OpenAI n'est pas disponible ; les données ne sont pas utilisées pour l'entraînement de modèles.",
  "consent.data3": "Métadonnées des champs du formulaire. Noms/types/espaces réservés (champs sensibles exclus).",
  "consent.data4": "URL de la page. Traitée par notre infrastructure (pour compatibilité/diagnostics), NON envoyée à OpenAI. Veuillez éviter les données personnelles dans les paramètres d'URL.",
  "consent.data5": "User-Agent du navigateur. Utilisé localement et par notre infrastructure (compatibilité/sécurité), NON envoyé à OpenAI.",
  "consent.data6": "Adresse IP. Enregistrée par l'infrastructure Google Cloud/Firebase pour la sécurité (jusqu'à 30 jours), NON envoyée à OpenAI.",
  "consent.section2_title": "Où et sur quelle base juridique les données sont-elles transférées ?",
  "consent.recipients": "Destinataires. OpenAI (États-Unis) — traitement audio/texte ; Google Cloud/Firebase (UE/Pologne) — hébergement et journaux de sécurité. Les données ne sont pas utilisées pour l'entraînement de modèles.",
  "consent.transfer1": "OpenAI (États-Unis). Les requêtes à OpenAI (y compris audio/texte) peuvent être stockées par OpenAI jusqu'à 30 jours pour prévenir les abus ; les données ne sont pas utilisées pour l'entraînement de modèles. Transfert vers les États-Unis — basé sur les CCT approuvées par la Commission européenne.",
  "consent.basis_title": "Bases juridiques :",
  "consent.basis1": "Fonction vocale — votre consentement (Art. 6(1)(a) RGPD).",
  "consent.basis2": "Journaux techniques (IP/UA/URL) — intérêts légitimes (Art. 6(1)(f)) — sécurité et débogage.",
  "consent.section3_title": "Vos droits",
  "consent.rights1": "Vous pouvez retirer votre consentement dans les paramètres du widget à tout moment ; cela n'affecte pas la légalité du traitement avant le retrait.",
  "consent.rights2": "En plus de retirer votre consentement, vous avez le droit de demander l'accès ou la suppression de vos données stockées dans nos systèmes (journaux techniques, métriques de coûts) via le propriétaire du site web. Détails complets dans la <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Politique de Confidentialité</a>.",
  "consent.rights3": "Cette fonctionnalité est destinée aux utilisateurs de 16 ans et plus ; pour les utilisateurs plus jeunes, le consentement parental/tuteur est requis.",
  "consent.footer_legal_title": "Informations Légales",
  "consent.footer_controller": "Responsable du traitement : le propriétaire de ce site web.",
  "consent.footer_processor": "TypelessForm : agit en tant que sous-traitant.",
  "consent.footer_contact": "Contact confidentialité : info@webappski.com.",
  "consent.footer_sccs": "Le transfert vers les États-Unis est effectué en vertu des CCT. Les détails sont disponibles dans notre <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Politique de Confidentialité</a>.",
...
//# sourceMappingURL=fr-CNI53h-K-VB7GG5A3.js.map
