// node_modules/typelessform-widget/dist/en-PiE0QJbW.js
var e = {
  ...
  "error.lowConfidence": "Could not clearly understand the audio. Please speak more clearly.",
  "error.general": "Something went wrong. Please try again.",
  "error.domainNotAllowed": "This domain is not authorized to use the service. Please contact the website administrator.",
  "error.serviceUnavailable": "Service temporarily unavailable. Please try again later or contact the website administrator.",
  ...
  "error.no_fields_detected": "Could not recognize information for filling the form. Please try to clearly specify what data should be entered in the fields.",
  ...
  "consent.subtitle": "Please read the information about your data protection carefully",
  // Anti-PII warning (hero banner)
  "consent.warning_title": "Important: Do Not Share Sensitive Data",
  "consent.warning": "Please do not speak passwords, payment details, government identifiers, or medical information. This data is not intended for processing by the voice feature.",
  // Summary cards (always visible)
  "consent.summary_card1_title": "What We Collect",
  "consent.summary_data1": "Voice recording → converted to text",
  "consent.summary_data2": "Field names/types/placeholders (without values; sensitive fields excluded)",
  "consent.summary_data3": "Technical logs (IP, browser info)",
  "consent.summary_card2_title": "Where It Goes",
  "consent.summary_transfer": "OpenAI (USA) for AI processing • Google Cloud/Firebase (EU, Poland) for hosting and security",
  "consent.summary_card3_title": "Your Rights",
  "consent.summary_rights": "Withdraw consent anytime • Request access or deletion of your data • Full details in <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</a>",
  ...
  "consent.data1": "Voice recording. Audio file sent to OpenAI Whisper via our server for transcription. File is not saved on server after processing.",
  "consent.data2": "Voice transcript (text). Sent to OpenAI GPT for form filling. We do not store the transcript on our servers; it is processed in memory and discarded after the response. We log only technical metadata (length, language, duration). Important: OpenAI may store request data for up to 30 days to prevent abuse; early deletion at OpenAI is not available; data is not used for model training.",
  "consent.data3": "Form field metadata. Names/types/placeholders (sensitive fields excluded).",
  "consent.data4": "Page URL. Processed by our infrastructure (for compatibility/diagnostics), NOT sent to OpenAI. Please avoid personal data in URL query parameters.",
  "consent.data5": "Browser User-Agent. Used locally and by our infrastructure (compatibility/security), NOT sent to OpenAI.",
  "consent.data6": "IP address. Logged by Google Cloud/Firebase infrastructure for security (up to 30 days), NOT sent to OpenAI.",
  // Section 2: Where and on what basis
  "consent.section2_title": "Where and on what legal basis is data transferred?",
  "consent.recipients": "Recipients. OpenAI (USA) — audio/text processing; Google Cloud/Firebase (EU/Poland) — hosting and security logs. Data is not used for model training.",
  "consent.transfer1": "OpenAI (USA). Requests to OpenAI (including audio/text) may be stored by OpenAI for up to 30 days to prevent abuse; data is not used for model training. Transfer to USA — based on SCCs approved by the European Commission.",
  "consent.basis_title": "Legal bases:",
  "consent.basis1": "Voice feature — your consent (Art. 6(1)(a) GDPR).",
  "consent.basis2": "Technical logs (IP/UA/URL) — legitimate interests (Art. 6(1)(f)) — security and debugging.",
  // Section 3: Your rights
  "consent.section3_title": "Your rights",
  "consent.rights1": "You can withdraw consent in widget settings at any time; this does not affect the lawfulness of processing before withdrawal.",
  "consent.rights2": "In addition to withdrawing consent, you have the right to request access or deletion of your data stored in our systems (technical logs and usage metrics) via the website owner. Full details in <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</a>.",
  "consent.rights3": "This feature is intended for users 16+; for younger users, parental/guardian consent is required.",
  // Footer legal info
  ...
  "consent.footer_sccs": "Transfer to USA is carried out under SCCs. Details are available in our <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</a>.",
...
//# sourceMappingURL=en-PiE0QJbW-L7QZLOY3.js.map
