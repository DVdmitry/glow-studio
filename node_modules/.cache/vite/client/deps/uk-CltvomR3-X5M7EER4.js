// node_modules/typelessform-widget/dist/uk-CltvomR3.js
var e = {
  "modal.title": "Розкажіть нам про ці теми",
  "modal.subtitle": "Ми розуміємо будь-яку мову, заповнюємо все і, за потреби, перекладаємо",
  ...
  "success.subtitle": "Перегляньте заповнені поля та надішліть, коли будете готові",
  "error.title": "Помилка",
  ...
  "error.domainNotAllowed": "Цей домен не авторизований для використання сервісу. Будь ласка, зверніться до адміністратора веб-сайту.",
  ...
  "error.no_fields_detected": "Не вдалося розпізнати інформацію для заповнення форми. Спробуйте чіткіше вказати, які дані потрібно ввести в поля.",
  ...
  "error.lowConfidence": "Не вдалося чітко розпізнати мову. Будь ласка, говоріть виразніше.",
  "button.close": "Закрити",
  // Consent modal
  "consent.title": "Ваша Конфіденційність Даних",
  "consent.subtitle": "Будь ласка, уважно прочитайте інформацію про захист ваших даних",
  "consent.warning_title": "Важливо: Не Діліться Конфіденційними Даними",
  "consent.warning": "Будь ласка, не називайте паролі, платіжні дані, державні ідентифікатори або медичну інформацію. Ці дані не призначені для обробки голосовою функцією.",
  "consent.summary_card1_title": "Що Ми Збираємо",
  "consent.summary_data1": "Голосовий запис → перетворено на текст",
  "consent.summary_data2": "Назви/типи/замінники полів (без значень; конфіденційні поля виключені)",
  "consent.summary_data3": "Технічні журнали (IP, інформація браузера)",
  "consent.summary_card2_title": "Куди Йде",
  "consent.summary_transfer": "OpenAI (США) для обробки AI • Google Cloud/Firebase (ЄС, Польща) для хостингу та безпеки",
  "consent.summary_card3_title": "Ваші Права",
  "consent.summary_rights": "Відкликати згоду будь-коли • Запросити доступ або видалення ваших даних • Повні деталі в <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Політиці конфіденційності</a>",
  "consent.full_details_title": "Прочитати Повні Деталі",
  "consent.section1_title": "Які дані ми обробляємо?",
  "consent.data1": "Голосовий запис. Аудіофайл надіслано до OpenAI Whisper через наш сервер для транскрипції. Файл не зберігається на сервері після обробки.",
  "consent.data2": "Голосова транскрипція (текст). Надіслано до OpenAI GPT для заповнення форм. За замовчуванням ми не зберігаємо транскрипцію в наших системах; у технічних журналах ми зберігаємо лише метадані (довжина тексту, мова, тривалість). Важливо: OpenAI може зберігати дані запитів до 30 днів для запобігання зловживанням; раннє видалення в OpenAI недоступне; дані не використовуються для навчання моделей.",
  "consent.data3": "Метадані полів форми. Назви/типи/замінники (конфіденційні поля виключені).",
  "consent.data4": "URL сторінки. Оброблено нашою інфраструктурою (для сумісності/діагностики), НЕ надіслано до OpenAI. Будь ласка, уникайте особистих даних у параметрах запиту URL.",
  "consent.data5": "User-Agent браузера. Використовується локально та нашою інфраструктурою (сумісність/безпека), НЕ надіслано до OpenAI.",
  "consent.data6": "IP-адреса. Записано інфраструктурою Google Cloud/Firebase для безпеки (до 30 днів), НЕ надіслано до OpenAI.",
  "consent.section2_title": "Куди і на якій правовій підставі передаються дані?",
  "consent.recipients": "Одержувачі. OpenAI (США) — обробка аудіо/тексту; Google Cloud/Firebase (ЄС/Польща) — хостинг та журнали безпеки. Дані не використовуються для навчання моделей.",
  "consent.transfer1": "OpenAI (США). Запити до OpenAI (включаючи аудіо/текст) можуть зберігатися OpenAI до 30 днів для запобігання зловживанням; дані не використовуються для навчання моделей. Передача до США — на основі SCC, схвалених Європейською комісією.",
  "consent.basis_title": "Правові підстави:",
  "consent.basis1": "Голосова функція — ваша згода (ст. 6(1)(a) GDPR).",
  "consent.basis2": "Технічні журнали (IP/UA/URL) — законні інтереси (ст. 6(1)(f)) — безпека та налагодження.",
  "consent.section3_title": "Ваші права",
  "consent.rights1": "Ви можете відкликати згоду в налаштуваннях віджета будь-коли; це не впливає на законність обробки до відкликання.",
  "consent.rights2": "Окрім відкликання згоди, ви маєте право запросити доступ або видалення ваших даних, що зберігаються в наших системах (технічні журнали, показники витрат) через власника веб-сайту. Повні деталі в <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Політиці конфіденційності</a>.",
  "consent.rights3": "Ця функція призначена для користувачів 16+; для молодших користувачів потрібна згода батьків/опікуна.",
  ...
  "consent.footer_contact": "Контакт з питань конфіденційності: info@webappski.com.",
  "consent.footer_sccs": "Передача до США здійснюється відповідно до SCC. Деталі доступні в нашій <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Політиці конфіденційності</a>.",
...
//# sourceMappingURL=uk-CltvomR3-X5M7EER4.js.map
