// node_modules/typelessform-widget/dist/da-CKlUkh5b.js
var e = {
  "modal.title": "Fortæl os om disse emner",
  "modal.subtitle": "Vi forstår ethvert sprog, udfylder alt og oversætter om nødvendigt",
  ...
  "success.subtitle": "Gennemse de udfyldte felter og indsend, når du er klar",
  ...
  "error.lowConfidence": "Kunne ikke forstå lyden tydeligt. Tal venligst tydeligere.",
  "error.general": "Noget gik galt. Prøv igen.",
  "error.domainNotAllowed": "Dette domæne er ikke autoriseret til at bruge tjenesten. Kontakt webstedets administrator.",
  ...
  "error.no_fields_detected": "Kunne ikke genkende information til at udfylde formularen. Prøv at angive tydeligere hvilke data der skal indtastes i felterne.",
  ...
  "consent.subtitle": "Læs venligst informationen om beskyttelse af dine data omhyggeligt",
  "consent.warning_title": "Vigtigt: Del Ikke Følsomme Data",
  "consent.warning": "Nævn venligst ikke adgangskoder, betalingsoplysninger, myndighedsidentifikatorer eller medicinske oplysninger. Disse data er ikke beregnet til behandling af stemmefunktionen.",
  "consent.summary_card1_title": "Hvad Vi Indsamler",
  "consent.summary_data1": "Stemmeoptagelse → konverteret til tekst",
  "consent.summary_data2": "Feltnavne/typer/pladsholdere (uden værdier; følsomme felter udelukket)",
  "consent.summary_data3": "Tekniske logs (IP, browserinfo)",
  "consent.summary_card2_title": "Hvor Det Går Hen",
  "consent.summary_transfer": "OpenAI (USA) til AI-behandling • Google Cloud/Firebase (EU, Polen) til hosting og sikkerhed",
  "consent.summary_card3_title": "Dine Rettigheder",
  "consent.summary_rights": "Tilbagekald samtykke når som helst • Anmod om adgang eller sletning af dine data • Fuld information i <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Privatlivspolitik</a>",
  "consent.full_details_title": "Læs Fulde Detaljer",
  "consent.section1_title": "Hvilke data behandler vi?",
  "consent.data1": "Stemmeoptagelse. Lydfil sendt til OpenAI Whisper via vores server til transskription. Filen gemmes ikke på serveren efter behandling.",
  "consent.data2": "Stemmetransskription (tekst). Sendt til OpenAI GPT til formularudfyldning. Som standard gemmer vi ikke transskriptionen i vores systemer; i tekniske logs gemmer vi kun metadata (tekstlængde, sprog, varighed). Vigtigt: OpenAI kan gemme anmodningsdata i op til 30 dage for at forhindre misbrug; tidlig sletning hos OpenAI er ikke tilgængelig; data bruges ikke til modeltræning.",
  "consent.data3": "Formularfeltmetadata. Navne/typer/pladsholdere (følsomme felter udelukket).",
  "consent.data4": "Side-URL. Behandlet af vores infrastruktur (til kompatibilitet/diagnostik), IKKE sendt til OpenAI. Undgå venligst personlige data i URL-forespørgselsparametre.",
  "consent.data5": "Browser User-Agent. Brugt lokalt og af vores infrastruktur (kompatibilitet/sikkerhed), IKKE sendt til OpenAI.",
  "consent.data6": "IP-adresse. Logget af Google Cloud/Firebase-infrastruktur til sikkerhed (op til 30 dage), IKKE sendt til OpenAI.",
  "consent.section2_title": "Hvortil og på hvilket retsgrundlag overføres data?",
  "consent.recipients": "Modtagere. OpenAI (USA) — lyd-/tekstbehandling; Google Cloud/Firebase (EU/Polen) — hosting og sikkerhedslogs. Data bruges ikke til modeltræning.",
  "consent.transfer1": "OpenAI (USA). Anmodninger til OpenAI (inklusive lyd/tekst) kan gemmes af OpenAI i op til 30 dage for at forhindre misbrug; data bruges ikke til modeltræning. Overførsel til USA — baseret på SCC godkendt af Europa-Kommissionen.",
  "consent.basis_title": "Retsgrundlag:",
  "consent.basis1": "Stemmefunktion — dit samtykke (Art. 6(1)(a) GDPR).",
  "consent.basis2": "Tekniske logs (IP/UA/URL) — legitime interesser (Art. 6(1)(f)) — sikkerhed og fejlfinding.",
  "consent.section3_title": "Dine rettigheder",
  "consent.rights1": "Du kan tilbagekalde samtykke i widget-indstillinger når som helst; dette påvirker ikke lovligheden af behandling før tilbagekaldelse.",
  "consent.rights2": "Ud over at tilbagekalde samtykke har du ret til at anmode om adgang eller sletning af dine data gemt i vores systemer (tekniske logs, omkostningsmålinger) via websideejeren. Fuld information i <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Privatlivspolitik</a>.",
  "consent.rights3": "Denne funktion er beregnet til brugere 16+; for yngre brugere kræves forældres/værges samtykke.",
  ...
  "consent.footer_sccs": "Overførsel til USA udføres under SCC. Detaljer er tilgængelige i vores <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Privatlivspolitik</a>.",
...
//# sourceMappingURL=da-CKlUkh5b-ILMQIIDJ.js.map
