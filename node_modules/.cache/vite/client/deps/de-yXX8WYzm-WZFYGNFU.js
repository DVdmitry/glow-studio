// node_modules/typelessform-widget/dist/de-yXX8WYzm.js
var e = {
  "modal.title": "Erzählen Sie uns von diesen Themen",
  "modal.subtitle": "Wir verstehen jede Sprache, füllen alles aus und übersetzen bei Bedarf",
  ...
  "listening.subtitle": "Sprechen Sie natürlich über das, was Sie ausfüllen möchten",
  ...
  "success.subtitle": "Überprüfen Sie die ausgefüllten Felder und senden Sie, wenn Sie bereit sind",
  ...
  "error.lowConfidence": "Audio konnte nicht klar verstanden werden. Bitte sprechen Sie deutlicher.",
  "error.general": "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.",
  "error.domainNotAllowed": "Diese Domain ist nicht berechtigt, den Service zu nutzen. Bitte wenden Sie sich an den Website-Administrator.",
  "error.serviceUnavailable": "Service vorübergehend nicht verfügbar. Bitte versuchen Sie es später erneut oder wenden Sie sich an den Website-Administrator.",
  ...
  "error.no_fields_detected": "Die Informationen zum Ausfüllen des Formulars konnten nicht erkannt werden. Bitte versuchen Sie, genauer anzugeben, welche Daten in die Felder eingegeben werden sollen.",
  ...
  "consent.subtitle": "Bitte lesen Sie die Informationen zum Schutz Ihrer Daten sorgfältig",
  "consent.warning_title": "Wichtig: Keine sensiblen Daten teilen",
  "consent.warning": "Bitte nennen Sie keine Passwörter, Zahlungsdetails, behördliche Kennungen oder medizinische Informationen. Diese Daten sind nicht zur Verarbeitung durch die Sprachfunktion vorgesehen.",
  "consent.summary_card1_title": "Was Wir Sammeln",
  "consent.summary_data1": "Sprachaufnahme → in Text umgewandelt",
  "consent.summary_data2": "Feldnamen/Typen/Platzhalter (ohne Werte; sensible Felder ausgeschlossen)",
  "consent.summary_data3": "Technische Protokolle (IP, Browser-Info)",
  "consent.summary_card2_title": "Wohin Es Geht",
  "consent.summary_transfer": "OpenAI (USA) für KI-Verarbeitung • Google Cloud/Firebase (EU, Polen) für Hosting und Sicherheit",
  "consent.summary_card3_title": "Ihre Rechte",
  "consent.summary_rights": "Einwilligung jederzeit widerrufen • Zugang oder Löschung Ihrer Daten anfordern • Vollständige Details in der <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Datenschutzerklärung</a>",
  "consent.full_details_title": "Vollständige Details Lesen",
  "consent.section1_title": "Welche Daten verarbeiten wir?",
  "consent.data1": "Sprachaufnahme. Audiodatei wird über unseren Server an OpenAI Whisper zur Transkription gesendet. Die Datei wird nach der Verarbeitung nicht auf dem Server gespeichert.",
  "consent.data2": "Sprachtranskription (Text). An OpenAI GPT zum Ausfüllen von Formularen gesendet. Standardmäßig speichern wir die Transkription nicht in unseren Systemen; in technischen Protokollen speichern wir nur Metadaten (Textlänge, Sprache, Dauer). Wichtig: OpenAI kann Anfragedaten bis zu 30 Tage speichern, um Missbrauch zu verhindern; vorzeitige Löschung bei OpenAI ist nicht verfügbar; Daten werden nicht zum Modelltraining verwendet.",
  "consent.data3": "Formularfeld-Metadaten. Namen/Typen/Platzhalter (sensible Felder ausgeschlossen).",
  "consent.data4": "Seiten-URL. Von unserer Infrastruktur verarbeitet (für Kompatibilität/Diagnose), NICHT an OpenAI gesendet. Bitte vermeiden Sie personenbezogene Daten in URL-Abfrageparametern.",
  "consent.data5": "Browser-User-Agent. Lokal und von unserer Infrastruktur verwendet (Kompatibilität/Sicherheit), NICHT an OpenAI gesendet.",
  "consent.data6": "IP-Adresse. Von Google Cloud/Firebase-Infrastruktur für Sicherheit protokolliert (bis zu 30 Tage), NICHT an OpenAI gesendet.",
  "consent.section2_title": "Wohin und auf welcher Rechtsgrundlage werden Daten übertragen?",
  "consent.recipients": "Empfänger. OpenAI (USA) — Audio-/Textverarbeitung; Google Cloud/Firebase (EU/Polen) — Hosting und Sicherheitsprotokolle. Daten werden nicht zum Modelltraining verwendet.",
  "consent.transfer1": "OpenAI (USA). Anfragen an OpenAI (einschließlich Audio/Text) können von OpenAI bis zu 30 Tage gespeichert werden, um Missbrauch zu verhindern; Daten werden nicht zum Modelltraining verwendet. Übermittlung in die USA — basierend auf von der Europäischen Kommission genehmigten SCC.",
  "consent.basis_title": "Rechtsgrundlagen:",
  "consent.basis1": "Sprachfunktion — Ihre Einwilligung (Art. 6(1)(a) DSGVO).",
  "consent.basis2": "Technische Protokolle (IP/UA/URL) — berechtigte Interessen (Art. 6(1)(f)) — Sicherheit und Debugging.",
  "consent.section3_title": "Ihre Rechte",
  "consent.rights1": "Sie können die Einwilligung in den Widget-Einstellungen jederzeit widerrufen; dies berührt nicht die Rechtmäßigkeit der Verarbeitung vor dem Widerruf.",
  "consent.rights2": "Zusätzlich zum Widerruf der Einwilligung haben Sie das Recht, Zugang oder Löschung Ihrer in unseren Systemen gespeicherten Daten (technische Protokolle, Kostenmetriken) über den Website-Eigentümer anzufordern. Vollständige Details in der <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Datenschutzerklärung</a>.",
  "consent.rights3": "Diese Funktion ist für Benutzer ab 16 Jahren vorgesehen; für jüngere Benutzer ist die Zustimmung der Eltern/Erziehungsberechtigten erforderlich.",
  "consent.footer_legal_title": "Rechtliche Informationen",
  "consent.footer_controller": "Verantwortlicher: der Eigentümer dieser Website.",
  "consent.footer_processor": "TypelessForm: handelt als Auftragsverarbeiter.",
  "consent.footer_contact": "Datenschutzkontakt: info@webappski.com.",
  "consent.footer_sccs": "Die Übermittlung in die USA erfolgt auf Grundlage von SCC. Details finden Sie in unserer <a href='https://webappski.com/en/legal/product-privacy' target='_blank' rel='noopener noreferrer'>Datenschutzerklärung</a>.",
...
//# sourceMappingURL=de-yXX8WYzm-WZFYGNFU.js.map
